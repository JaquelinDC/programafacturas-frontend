...
export default defineConfig({
  ...
  build: {
    // Permite sobreescribir el destino con la variable de entorno BUILD_OUTDIR.
    // Ejemplo producción integrada: BUILD_OUTDIR=../programafacturas/src/main/resources/static
