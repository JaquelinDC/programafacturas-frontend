...
definePage({ meta: { title: 'Conciliación proveedor' } })
...
<template>
  <VCard>
    <VCardItem>
      <VCardTitle>Conciliación de extracto</VCardTitle>
    ...
    <VCardText>
      <div class="mb-4 text-body-2 text-disabled">
        Muestra los movimientos pendientes del extracto para enlazarlos manualmente desde la vista de detalle.
      </div>
